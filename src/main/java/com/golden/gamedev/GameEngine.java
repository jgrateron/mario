...
public abstract class GameEngine extends Game {
	...
	public CheckPoints currentGameID;
	 ...
	 * @see #nextGame
	 */
	public CheckPoints nextGameID  ; //= 11;
        
        
        public int MarioStatus = 1 ;
	...
	void startGameLoop() {
		...
		while (this.isRunning()) {
			...
			if (this.nextGameID.NextLevel == -1 && this.nextGame == null) {
			...
			if (this.nextGameID.NextLevel == this.currentGameID.NextLevel) {
				this.nextGameID.NextLevel = -1;
			}
	...
	public int getCurrentGameID() {
		return this.currentGameID.NextLevel;
	}
