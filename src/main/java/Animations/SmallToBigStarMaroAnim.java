...
public class SmallToBigStarMaroAnim extends AnimatedSprite {
    ...
    public SmallToBigStarMaroAnim(double x, double y, BufferedImage[] storedImages, Mario g ,boolean  right ) {
